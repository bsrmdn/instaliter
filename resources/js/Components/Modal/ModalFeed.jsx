        ...
        <Modal show={open} onClose={setOpenFeed} modalRef={modalRef} maxWidth='max-w-sm md:max-w-none max-h-none md:max-h-[calc(100vh-4rem)]'>
            <div className="flex flex-col md:flex-row max-h-[calc(100vh-8rem)]">
                ...
                <div className="flex flex-col md:w-[25rem] w-full divide-y dark:divide-neutral-800 divide-neutral-200">
                    ...
                    <Feed.Bottom post={post} className={`px-4 dark:text-white `} withCaption={false}>
                        <Feed.ButtonInteractionsFeed>
                            <Feed.LikeButton postId={post.id} isLiked={post.likes.some(like => like.user_id === authUser.user.id)} />
