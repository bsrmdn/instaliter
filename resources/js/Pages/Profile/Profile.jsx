...
function HeaderOptions({ user }) {
    ...
    return (
        <div className="flex gap-2 flex-wrap sm:flex-nowrap">
            {isAuthUser ?
                <>
                    <SecondaryButton children={'Edit Profile'} href={route('profile.edit')} className='grow sm:grow-0' />
                    <SecondaryButton children={'View archive'} className='grow sm:grow-0' />
                    <SecondaryButton children={'Ad tools'} className='grow sm:grow-0' />
                    <Link as="button" type='button' className='hidden sm:block'>
                ...
                :
                <>
                    <PrimaryButton children={'Follow'} className='grow sm:grow-0' />
                    <SecondaryButton children={'Message'} className='grow sm:grow-0' />
                    <Link as='button' className='hidden sm:block'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className='space-y-11'>
            <div className="flex">
                <div className="flex-grow me-8">
                    <Avatar avatar={props.user.avatar} avatarOnly className={'w-28 sm:w-36 mx-auto'} />
                </div>
                <div className="flex flex-col flex-grow-[2] space-y-4">
                    ...
                    <ul className="flex gap-x-10 flex-wrap">
                        <li><span className='font-bold grow'>{props.postLength}</span> posts</li>
                        <li><span className='font-bold grow'>0</span> followers</li>
                        <li><span className='font-bold grow'>0</span> following</li>
                    </ul>
