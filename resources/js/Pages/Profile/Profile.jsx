...
Profile.PageLayout = page => <PageLayout children={page} />
...
const TabContentButton = forwardRef(({ name, children, isActive = false, onClick }, ref) => {

    return (
        <button ref={ref} type="button" preserveState onClick={(e) => onClick()} className={`${isActive ? `border-t dark:border-white border-black text-black dark:text-white` : `dark:text-neutral-300 text-neutral-800`} flex items-center justify-center py-5 text-start leading-tight`}>
...
function TabContent() {
    ...
    return (
        <div className="flex justify-center gap-14">
            <TabContentButton ref={buttonRef} name={'posts'} onClick={() => selectTab('posts')} isActive={tab == 'posts'}>
            ...
            <TabContentButton ref={buttonRef} name={'saved'} onClick={() => selectTab('saved')} isActive={tab == 'saved'}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" />
                </svg>
            </TabContentButton>
            <TabContentButton ref={buttonRef} name={'tagged'} onClick={() => selectTab('tagged')} isActive={tab == 'tagged'}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
